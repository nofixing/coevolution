                  ...
                  <form action="">
                      <div class="form-box">
                          ...
                          <div class="join-form-tb">
                              <div class="tb-tr">
                                  <div class="tb-th"><span>*</span> 아이디</div>
                                  <div class="tb-td" id="idview">
                                      <input type="text" class="input-box" placeholder="아이디를 입력하세요" style="ime-mode:disabled;" maxlength="10" id="cust_id" name="cust_id">
                                      <div class="chk-btn idchk-btn"><a href="javascript:void(0);" id="btnDupCheck">중복확인</a></div>
