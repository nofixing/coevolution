                  ...
                  <form action="">
                      <div class="form-box">
                          ...
                          <div class="join-form-tb">
                              <div class="tb-tr">
                                  <div class="tb-th"><span>*</span> <spring:message code="join_form3.id" text="아이디"/></div>
                                  <div class="tb-td" id="idview">
                                      <input type="text" class="input-box" placeholder="<spring:message code='join_form3.id.placeholder' text='아이디를 입력하세요'/>" style="ime-mode:disabled;" maxlength="10" id="cust_id" name="cust_id">
                                      <div class="chk-btn idchk-btn"><a href="javascript:void(0);" id="btnDupCheck"><spring:message code="join_form3.id.check.availability" text="중복확인"/></a></div>
                                      <p class="notice">※ <spring:message code="join_form3.id.check.message" text="아이디는 6자 이상, 10자 이하 영문 소문자와 숫자만 사용 가능합니다."/></p>
                                  </div>
                              </div>
                              <div class="tb-tr">
                                  <div class="tb-th"><span>*</span> <spring:message code="join_form3.pw" text="비밀번호"/></div>
                                  <div class="tb-td">
                                      <input type="password" minlength="6" maxlength="15" class="input-box" placeholder="<spring:message code='join_form3.pw.placeholder' text='비밀번호를 입력하세요'/>" id="cust_pw" name="cust_pw">
                                      <p class="notice">※ <spring:message code="join_form3.pw.check.message" text="비밀번호는 영문, 숫자 혼용하여 6~15자 이내로 입력해주세요."/></p>
                                  </div>
                              </div>
                              <div class="tb-tr">
                                  <div class="tb-th"><span>*</span> <spring:message code="join_form3.pw.check" text="비밀번호 확인"/></div>
                                  <div class="tb-td">
