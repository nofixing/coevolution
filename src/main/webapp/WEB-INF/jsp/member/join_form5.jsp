                  ...
                  <div class="form-box">
                      ...
                      <div class="join-form-tb">
                          ...
                          <div class="tb-tr">
                              ...
                              <div class="tb-td">
                                  <input type="password" id="cust_pw" name="cust_pw" minlength="6" maxlength="10" class="input-box" placeholder="비밀번호를 입력하세요">
                          ...
                          <div class="tb-tr">
                              ...
                              <div class="tb-td">
                                  <input type="password" id="cust_pw2" name="cust_pw2" minlength="6" maxlength="10" class="input-box">
                              </div>
                          </div>
                          <div class="tb-tr">
