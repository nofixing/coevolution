...
<!-- 진행순서
              ...
              <div class="form-row">
                <div class="form-group col-md-12">
                  ...
                  <div class="form-row align-items-center">
                    <div class="col-md-3">
                      <input type="text" class="form-control form_height1" name="email_id1" id="email_id1" value="${email_id1}" maxlength="50">
                    </div>
                    <div class="col-md-3">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control form_height1" name="email_id2" id="email_id2" value="${email_id2}" maxlength="50">
                      </div>
                    </div>
                    <div class="col-md-3">
  ...
  <jsp:include page="join_form6_js.jsp"></jsp:include>
