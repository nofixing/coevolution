...
function consult_cust_search() {
    ...
    sendForm("POST", "/mypage/myc08M03", "application/json; charset=utf-8", "json", pParamJson, function(message) {
...
function consult_search(pSndCustId) {
    ...
    sendForm("POST", "/mypage/myc08M02", "application/json; charset=utf-8", "json", pParamJson, function(message) {
