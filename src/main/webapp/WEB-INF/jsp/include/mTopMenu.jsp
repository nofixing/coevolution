...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
    ...
    <div class="m-menu">
        <div class="m-menu-top">
            ...
            <span>
            <c:choose>
                <c:when test="${empty sessionScope.login_mgnt_session.cust_nm}">
                    <spring:message code="login.please.log.in" text="로그인 해주세요"/>
                </c:when>
                <c:otherwise>
                  <c:if test="${sessionScope.LANG ne 'en'}">
                    ${sessionScope.login_mgnt_session.cust_nm}님 반갑습니다.
                  </c:if>
                  <c:if test="${sessionScope.LANG eq 'en'}">
                    Welcome to ${sessionScope.login_mgnt_session.cust_nm}
                  </c:if>
                </c:otherwise>
            </c:choose>
                ...
                <div class="m-menu-shop">
                    <ul class="clearfix">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <c:if test="${sessionScope.login_mgnt_session.cust_clsf_cd eq '202001'}">
                                    <a href="/mypage/favorts" class="nav-link nav-item-font">
                                    </c:if>
                                    <c:if test="${sessionScope.login_mgnt_session.cust_clsf_cd eq '202002'}">
                                    <a href="/mypage/myc01" class="nav-link nav-item-font">
                                    </c:if>    
                                    <c:if test="${sessionScope.login_mgnt_session.cust_clsf_cd eq '202003'}">
                                    <a href="/mgnt/expo" class="nav-link nav-item-font">
                                    </c:if>   
            ...
            <div class="m-menu-box" >
                <div class="m-menu-list">
                    <ul class="m-menu-depth">
                        ...
                        <c:choose>
                        <c:when test="${sessionScope.login_mgnt_session.cust_clsf_cd eq '202002'}">
                        <li>
