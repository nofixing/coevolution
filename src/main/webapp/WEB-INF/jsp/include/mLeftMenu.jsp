...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
  ...
  <ul class="list-unstyled sidenav-list">
    ...
    <li class="text-xs text-uppercase border p-2">
      <a href="#" <c:if test="${page_clsf eq ''}">class="on"</c:if> ><strong>상담문의내역</strong></a>
    </li>
    ...
    <li class="text-xs text-uppercase border p-2">
      ...
      <div id="member" class="collapse show pl-3">
        <ul class="list-group">
          <li class="list-group"><a href="#" <c:if test="${page_clsf eq ''}">class="on"</c:if> ><strong>참관회원</strong></a></li>
    ...
    <li class="text-xs text-uppercase border p-2">
      ...
      <div id="stats" class="collapse show pl-3">
        <ul class="list-group">
          ...
          <li class="list-group"><a href="#" <c:if test="${page_clsf eq ''}">class="on"</c:if>><strong>구글애널리틱스-2순위</strong></a></li>
