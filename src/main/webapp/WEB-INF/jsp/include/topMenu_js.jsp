...
function setCategoriHtml(corpList) {
	...
	for(var i = 0; i < corpList.length; i++) {
		...
		vCategoriHtml += '        <!-- Image --> ';
		vCategoriHtml += '        <img src="'+corpList[i].ci_url+'" class="mb-3" style="width: 110px;" onerror="this.style.display=\'none\'"> ';
		vCategoriHtml += '    </div> ';
		...
		if(corpList[i].favorts_yn == "Y") {
			vCategoriHtml += '            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bookmark-star text-warning" viewBox="0 0 16 16"> ';
		} else {
			vCategoriHtml += '            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bookmark-star" viewBox="0 0 16 16"> ';
		}
		...
		if(corpList[i].badge_yn == "Y") {
			vCategoriHtml += '            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-award text-warning" viewBox="0 0 16 16"> ';
		} else {
			vCategoriHtml += '            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-award" viewBox="0 0 16 16"> ';
		}
