                ...
                <div class="main-article">
                    <c:if test="${sessionScope.LANG eq 'en'}">
                     ...
                     <div class="main-article-btn">
                         <a href="http://www.ievexpo.org/site/ieve2018/kor/contents/index.php?mid=0310" target="_blank"><span><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-badge-vr" viewBox="0 0 16 16">
                                            ...
                                            </svg></span><span>버추얼전시회<br>사 전 등 록</span></a>
